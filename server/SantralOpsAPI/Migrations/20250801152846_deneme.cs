...
namespace SantralOpsAPI.Migrations
{
    ...
    public partial class deneme : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TelefonAramaKayitlari",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Yonu = table.Column<int>(type: "int", nullable: false),
                    AramaZamani = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Notlar = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TelefonNumarasiId = table.Column<int>(type: "int", nullable: false),
                    PersonelId = table.Column<int>(type: "int", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelefonAramaKayitlari", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TelefonAramaKayitlari_Personeller_PersonelId",
                        column: x => x.PersonelId,
                        principalTable: "Personeller",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TelefonAramaKayitlari_TelefonNumaralari_TelefonNumarasiId",
                        column: x => x.TelefonNumarasiId,
                        principalTable: "TelefonNumaralari",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TelefonAramaKayitlari_PersonelId",
                table: "TelefonAramaKayitlari",
                column: "PersonelId");

            migrationBuilder.CreateIndex(
                name: "IX_TelefonAramaKayitlari_TelefonNumarasiId",
                table: "TelefonAramaKayitlari",
                column: "TelefonNumarasiId");
